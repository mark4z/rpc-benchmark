...
type SimpleServiceClient interface {
	// Sends a greeting
	SimpleRpc(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleReply, error)
}
...
func (c *simpleServiceClient) SimpleRpc(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleReply, error) {
	out := new(SimpleReply)
	err := c.cc.Invoke(ctx, "/com.example.springmock.grpc.SimpleService/SimpleRpc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServiceServer interface {
	// Sends a greeting
	SimpleRpc(context.Context, *SimpleRequest) (*SimpleReply, error)
...
func (UnimplementedSimpleServiceServer) SimpleRpc(context.Context, *SimpleRequest) (*SimpleReply, error) {
...
func _SimpleService_SimpleRpc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.example.springmock.grpc.SimpleService/SimpleRpc",
	}
...
var SimpleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.example.springmock.grpc.SimpleService",
